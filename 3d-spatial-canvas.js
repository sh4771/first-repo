document.addEventListener('DOMContentLoaded', function() {
  ...
  assignmentTab.addEventListener('click', function(e) {
    ...
    // Initialize Three.js when assignment tab becomes visible
    setTimeout(() => {
      if (typeof handleAssignmentTabClick === 'function') {
        handleAssignmentTabClick();
      } else if (typeof initThreeJS === 'function') {
        initThreeJS();
      }
    }, 100);
  });
